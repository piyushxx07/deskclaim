  ...
  return (
    <div>
      <div className="cd-page-header">
        <div>
          <h2>My Vouchers</h2>
          <p>All vouchers you have created.</p>
        </div>
      ...
      <div className="cd-card p-3">
        ...
        {loading ? (
          ...
          <div className="cd-empty-state">
            ...
            <p className="mt-2 mb-0">No vouchers found.</p>
          </div>
        ) : (
          <div className="table-responsive">
            <table className="table cd-table align-middle">
              <thead>
                <tr>
                  <th>Voucher #</th><th>Title</th><th>Department</th><th>Date</th><th>Amount</th><th>Status</th><th></th>
                </tr>
              </thead>
              <tbody>
                {rows.map((v) => (
                  <tr key={v.id}>
                    ...
                    <td className="text-end">
                      <Link to={`/employee/vouchers/${v.id}`} className="btn btn-sm btn-outline-secondary">
